...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <p>Enter ID 			: <input type="text" name="id" id="id"><br></p>
      <p>Enter FIRST NAME 		: <input type="text" name="firstname" id="firstname"><br></p>
      <p>Enter LAST NAME 	: <input type="text" name="lastname" id="lastname"><br></p>
      <p>Enter COUNTRY ID 		: <input type="text" name="countryid" id="countryid"><br></p>
