<!DOCTYPE html>
<%@page import="com.cricinfo.entity.MatchCalendar"%>
...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <table border=\"1\">
      	<tr>
			<th width="200px">S.NO.</th><th width="200px">Upcoming Matches</th><th width="150px">Date</th><th width="150px">Delete</th>
		</tr>
      <%for(MatchCalendar l : (ArrayList<MatchCalendar>) request.getAttribute("matches")){ %>
       	<tr>
			<td><%= l.getUnique_id() %></td>
			<td><%= l.getName()%></td>
			<td><%= l.getDate()%></td>
