...
<div class="container-fluid text-center">    
  <div class="row content">
    ...
    <div class="col-sm-8 text-left"> 
      ...
      <table border=\"1\">
      	<tr>
			<th width="200px">S.NO.</th><th width="200px">LEAGUE</th><th width="150px">Delete</th>
		</tr>
      <%for(League l : (ArrayList<League>) request.getAttribute("leagues")){ %>
       	<tr>
			<td><%= l.getId() %></td>
			<td><%= l.getName()%></td>
            <td><a href=<%= "\"deleteLeague?id=" + l.getId() + "\"" %>>Delete</a></td>
		</tr>
		<%} %>
	</table>
    </div>
